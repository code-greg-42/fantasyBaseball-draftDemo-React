...
function App() {
  ...
  return (<>
    ...
    {navSelect === 'League Leaderboard' ? <TeamTable setSelectedPlayer={setSelectedPlayer} myProposalEvents={myProposalEvents} roundsDrafted={roundsDrafted} setShowLoginSuccessNote={setShowLoginSuccessNote} leagueHasStarted={leagueHasStarted} setLeagueHasStarted={setLeagueHasStarted}
